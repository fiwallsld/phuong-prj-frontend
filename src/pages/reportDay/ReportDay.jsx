      ...
      sections: [
        {
          children: [
            new Paragraph({
              children: [new TextRun({ text: "BÁO BAN NỘI VỤ", bold: true, size: 32 })],
              alignment: "center",
            }),
            new Paragraph(" "),
            new Paragraph({
    ...
    <>
      ...
      <div className="container-fluid p-10">
        <div id="body-header" className="grid grid-cols-3">
          ...
          <div className="text-center">
            <h1 className="text-3xl font-bold">BÁO BAN NỘI VỤ</h1>
          </div>
          <div className="text-center">
        ...
        <div className="grid grid-cols-3 gap-4 p-4 bg-gray-100">
          <div className="bg-gray-100 p-4 rounded-md max-w-sm">
            <div className="mb-4 flex items-center">
              ...
              <input type="number" name="total" id="total" className="bg-gray-300 h-6 w-48 rounded-md text-center" value={reportData.total} onChange={handleInputChange} />
            </div>

            <div className="mb-4 flex items-center">
              <label htmlFor="present" className="font-bold w-28">Có mặt:</label>
              <input type="number" name="present" id="present" className="bg-gray-300 h-6 w-48 rounded-md text-center" value={reportData.present} onChange={handleInputChange} />
            </div>

            <div className="mb-4 flex items-center">
              <label htmlFor="absent" className="font-bold w-28">Vắng mặt:</label>
              <input type="number" name="absent" id="absent" className="bg-gray-300 h-6 w-48 rounded-md text-center" value={reportData.absent} onChange={handleInputChange} />
            </div>

            <div className="flex items-start">
              <label htmlFor="reason" className="font-bold w-28">Lý do:</label>
              <textarea name="reason" id="reason" rows="5" className="bg-gray-300 w-48 h-20 rounded-md p-2" value={reportData.reason} onChange={handleInputChange}></textarea>
            </div>
          </div>

          <div className="bg-gray-200 p-4 rounded-md">
            <div className="font-bold">HOẠT ĐỘNG CHÍNH CỦA ĐƠN VỊ TRONG NGÀY</div>
            <textarea name="activity" className="bg-gray-300 w-full h-32 mt-2 rounded-md p-2" value={reportData.activity} onChange={handleInputChange}></textarea>
          </div>

          <div className="bg-gray-200 p-4 rounded-md">
            <div className="font-bold">NHẬN XÉT ƯU KHUYẾT ĐIỂM TRONG NGÀY VỀ NỘI VỤ</div>
            <textarea name="remarks" className="bg-gray-300 w-full h-32 mt-2 rounded-md p-2" value={reportData.remarks} onChange={handleInputChange}></textarea>
          </div>

          <div className="">
            <div className="col-span-3 bg-gray-200 p-4 rounded-md">
              <div className="font-bold">Vũ khí trang bị lớn mang ra khỏi đơn vị:</div>
              <input name="equipment" type="text" className="bg-gray-300 h-6 w-full mt-2 rounded-md p-2" value={reportData.equipment} onChange={handleInputChange} />
            </div>

            <div className="col-span-3 bg-gray-200 p-4 rounded-md">
              <div className="font-bold">NHỮNG CÔNG VIỆC ĐỘT XUẤT XẢY RA</div>
              <textarea name="suddenWork" className="bg-gray-300 w-full h-20 mt-2 rounded-md p-2" value={reportData.suddenWork} onChange={handleInputChange}></textarea>
            </div>
          ...
          <div className="bg-gray-200 p-4 rounded-md">
            ...
            <textarea name="taskSituation" className="bg-gray-300 w-full h-32 mt-2 rounded-md p-2" value={reportData.taskSituation} onChange={handleInputChange}></textarea>
          </div>
