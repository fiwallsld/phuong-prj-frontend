...
const HomeContent = () => {
    ...
    return (
        <div className="container-fluid px-8">
            <h1 className="titleHotNews mt0"><span>Quân đoàn 3 - “Quyết thắng, sáng tạo, đoàn kết, thống nhất, nghiêm túc, tự lực”</span></h1>
            <div className="w100-on-xs">
